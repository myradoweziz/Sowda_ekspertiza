	...
	<div class="transport">
		<div class="transport__container">
			<div class="transport__title-box">
				<div class="transport__title">Kaka | Habarlaşmak</div>
							...
							<tr v-for="(item, index) in contacts" :key="item.uuid">
								...
								<td style="width: 150px">
									<div style="width: 100%; display: flex">
										<Button @onClick="selectContact(item)" prependIcon="edit2Admin" onlyIcon />
		...
		methods: {
			...
			async getCity() {
				try {
					...
					await this.getContact(this.cities[2].uuid)
				} catch (error) {
					console.error(error)
				}
			},
