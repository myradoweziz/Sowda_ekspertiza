	...
	<div class="transport">
		<div class="transport__container">
			<div class="transport__title-box">
				<div class="transport__title">Bäherden</div>
			...
			<div class="transport__body">
				<div class="transport__table">
					<table>
						...
						<tbody>
							<tr v-for="item in enterprices" :key="item.uuid">
								<td>
	...
	export default {
		...
		methods: {
			...
			changeCities(idx) {
				...
				if (idx == 2) {
					this.$router.push('/marketing/companies/communicate')
				}
			},
			...
			async getCity() {
				try {
					...
					await this.getEnterprice(this.cities[1].uuid)
				} catch (error) {
					console.error(error)
				}
			},
